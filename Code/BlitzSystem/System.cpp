...
bool System::Init(HINSTANCE hInstance, int nCmdShow)
{
...
double System::QueryCPUFrameTime()
{
...
bool System::CreateGameWindow(HINSTANCE hInstance, HWND& outHwnd)
{
...
void System::Quit(WPARAM retParam)
{
	mRetParam = retParam;
	mQuitGame = true;
}
