...
struct MATH_EXPORT Vector4
{
	...
	MATH_EXPORT friend Vector4 operator+(Vector4 left, const Vector4& right);
	MATH_EXPORT friend Vector4 operator-(Vector4 left, const Vector4& right);
	MATH_EXPORT friend Vector4 operator*(Vector4 left, const Vector4& right);
	MATH_EXPORT friend Vector4 operator/(Vector4 left, const Vector4& right);

	MATH_EXPORT friend Vector4 operator*(Vector4 left, const class Matrix4& right);

	MATH_EXPORT friend Vector4 operator*(Vector4 left, const float& right);
	MATH_EXPORT friend Vector4 operator/(Vector4 left, const float& right);
	...
	MATH_EXPORT friend std::ostream& operator<<(std::ostream& stream, const Vector4 Vector);
